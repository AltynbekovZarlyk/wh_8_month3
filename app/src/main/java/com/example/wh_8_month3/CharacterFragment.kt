...
import com.example.wh_8_month3.databinding.FragmentCharacterBinding
...
class CharacterFragment : Fragment() {
    ...
    private fun onItemClick(character: Character) {
        findNavController().navigate(CharacterFragmentDirections.actionCharacterFragmentToInfoCharacterFragment(character))
    }
}